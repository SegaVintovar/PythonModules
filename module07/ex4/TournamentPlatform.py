...
class TournamentPlatform():
    ...
    def create_match(self, card1_id: str, card2_id: str) -> dict:
        ...
        # player1.rating = player1.calculate_rating()
        # player2.rating = player2.calculate_rating()
        ...
        looser.rating -= 16
        looser.losses += 1
        result = {"winner": winner.id, "looser": looser.id,
                  "winner_rating": winner.rating, "looser_rating": looser.rating}
    ...
    def generate_tournament_report(self) -> dict:
        ...
        for card in self.cards:
            ...
            i += 1
        avg_rating = total / i
        result = {'total_cards': len(self.cards), 'matches_played': self.matches_played,
